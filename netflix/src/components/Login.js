...
const Login = () => {
    ...
    const getInputData = async (e)=>{
        //here we get data of username,gmail and password 
        //now we store these data into mongodb
        e.preventDefault();//to avoid reload of page we use e.preventDefault()
        ...
        //after submission of details we clear fullname,email and password
        setFullName("");
        setEmail("");
        setPassword("");
    }
    ...
    return (
        <div>
            //we call here header means header is constant...
            <Header />
            ...
            //here we build a form for fullname,password  and email....
